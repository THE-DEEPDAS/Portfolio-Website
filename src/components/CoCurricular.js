...
const CoCurricular = () => {
    const images = [
        ...
        },
        {
            ...
            description: '🏏 Actively involved in a range of sports, from cricket and badminton to tug of war, highlighting versatility and teamwork.',
        },
        {
            image: [
                require('./Assets/chess1.png'),
                require('./Assets/chess2.png'),
            ],
    ...
    return (
        ...
        >
            ...
            <p>
                Explore a selection of my co-curricular activities that illustrate my engagement in diverse interests and pursuits outside the classroom.
            </p>
            <div
